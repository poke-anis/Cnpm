          ...
          { declaData.Description_Evolution != null &&
            ...
            <BigBox>
              ...
              >
                ...
                <Col sm="7">
                  <Form.Control readOnly defaultValue={declaData.Conséquences_S_V_Q} />
                </Col>
              </Form.Group>
              {declaData.Conséquences_S_V_Q === "Oui" ? (
                <Form.Group
                  as={Row}
                  className="mb-3"
                  controlId="formPlaintextEmail"
                >
                  <Form.Label column sm="5">
                    Types de Conséquences sur la vie quotidienne
                  </Form.Label>
                  <Col sm="7">
                    <Form.Control readOnly defaultValue={declaData.Conséquences_S_V_Q_O} />
                  </Col>
                </Form.Group>
              ) : null}
