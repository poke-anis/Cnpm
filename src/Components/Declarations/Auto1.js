    ...
    return (
      <FlexBox>
        ...
        Object(values).map((word,key) => {
           ...
           // filter(formik.values.Reaction0.Description_D_L_R,'Point_I') === 'Point_I'
            /* 
        filter(formik.values.Reaction0.Description_D_L_R,'Systemiques') === 'Systemiques'?
<label htmlFor="Systemiques">Systemiques
        <Field
          ...
          options={Systemiques}
        /></label>:
        filter(formik.values.Reaction0.Description_D_L_R,'Infectieux') === 'Infectieux'?
